package com.owl.spring.member.domain;
...
public class Member {
	...
	public String toString() {
		return "회원 [아이디=" + memberId + ", 비밀번호=" + memberPw + ", 이름=" + memberName + ", 나이=" + memberAge + ", 성별="
				+ memberGender + ", 이메일=" + memberEmail + ", 전화번호=" + memberPhone + ", 주소=" + memberAddress + ", 취미="
				+ memberHobby + ", 가입날짜=" + memberDate + ", 수정날짜=" + updateDate + ", 회원여부=" + memberYn + "]";
	}
